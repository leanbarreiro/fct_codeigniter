...
$("#listlogusuarios").jqGrid({
    ...
    colModel:[
        ...
        {name:'seccion',index:'seccion', align:"center", width:250, editable:true, editoptions:{size:30}},
        {name:'accion',index:'accion', align:"center", width:200, editable:true, editoptions:{size:30}},
        {name:'cambios',index:'cambios', align:"left", width:400, editable:true, editoptions:{size:30}},
        {name:'fecha',index:'fecha', align:"center", width:250, editable:true, editoptions:{size:30}}
    ],
    rowNum: 20,
    rowList:[10,20,30,50],
